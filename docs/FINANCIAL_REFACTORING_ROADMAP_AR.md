...
- إنشاء `FinancialSummaryService` كبداية للمصدر المالي المشترك لملخصات لوحة المالك اليومية والشهرية وبطاقات المتاجر، وربطه بالتقرير الشهري للمتجر وتقرير البحث الشامل وصفحة تفاصيل المتجر.
- وجود خدمات تقارير متجر منفصلة، خصوصًا التقرير الشهري والبحث الشامل وملفات التقارير الحديثة، مع بدء حذف الدوال والخدمات الخاملة بعد نقل المسؤوليات للخدمات المشتركة.
