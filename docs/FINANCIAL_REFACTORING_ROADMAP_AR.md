...
**تقدم الخطوة التالية:** بدأت اختبارات التثبيت من طبقة DTO بإضافة اختبار `FinancialSummaryResult` و`StoreFinancialSummary` لضمان ثبات جمع الإجماليات، معادلة الربح، ومفاتيح `toLegacyArray` قبل نقل بقية الصفحات من المصفوفات القديمة إلى DTOs. وتم ربط مؤشرات ذمم الموظفين غير النقدية (`employee_debt_balance`, `employee_credit_outstanding`, `employee_credit_collections`) بخدمة الملخص المالي مع تثبيت أنها لا تدخل في ربح المتجر أو كاش الشفت افتراضيًا.
