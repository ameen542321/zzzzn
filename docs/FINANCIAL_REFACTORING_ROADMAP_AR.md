...
- إنشاء `FinancialSummaryService` كبداية للمصدر المالي المشترك لملخصات لوحة المالك اليومية والشهرية وبطاقات المتاجر، وربطه بالتقرير الشهري للمتجر وتقرير البحث الشامل.
- وجود خدمات تقارير متجر منفصلة، خصوصًا التقرير الشهري والبحث الشامل وملفات التقارير الحديثة.

**ما لم يكتمل بعد:** DTOs المالية المركزية، اختبارات التثبيت المقترحة، توسيع اعتماد `FinancialSummaryService` في بقية التقارير والواجهات، توحيد الكنترولرات والواجهات على الخدمات، وحذف الحسابات القديمة بعد المقارنة.
