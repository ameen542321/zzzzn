...
- إنشاء `FinancialSummaryService` كبداية للمصدر المالي المشترك لملخصات لوحة المالك اليومية والشهرية وبطاقات المتاجر، وربطه بالتقرير الشهري للمتجر وتقرير البحث الشامل وصفحة تفاصيل المتجر وتقارير الاستهلاك الداخلي.
- وجود خدمات تقارير متجر منفصلة، خصوصًا التقرير الشهري والبحث الشامل وملفات التقارير الحديثة، مع بدء حذف الدوال والخدمات الخاملة بعد نقل المسؤوليات للخدمات المشتركة، وتوحيد فلترة مصروفات المتجر الشهرية على `betweenAccountingDates`.
