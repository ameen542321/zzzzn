...
- استكمال خدمة عمليات مالية مشتركة لـ `Sale`, `Expense`, و`Withdrawal`، ومتابعة توحيد تاريخ عمليات الموظف التي بدأت بالاعتماد على `date` بدل `created_at` في الغياب والمديونيات والآجل.
