...
- نقل ملخصات صفحة المتجر والإحصاءات المتقدمة من `StoreController`، وتم ربط ملخصات `StoreDetailsService` المالية بـ `FinancialSummaryService` جزئيًا، وحذف دوال تقرير HTML/UltraMsg الخاملة من لوحة المحاسب وخدمة `NotificationQueryService` غير المستخدمة، مع بقاء مراجعة إحصاءات المخزون والموظفين لأنها قد تكون خدمات صفحة لا خدمات مفاهيمية مشتركة.
